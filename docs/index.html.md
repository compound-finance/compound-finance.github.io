...
For documentation of the Compound v2 Protocol, see [docs.compound.finance/v2](/v2/index.html.md).
...
The v3 proxy is the only address to be used to interact with a Compound III instance. It is the first address listed in each of the tabs below. To generate the proper [Comet Interface ABI](/public/files/comet-interface-abi-98f438b.json) (`CometInterface.sol`), compile the Comet project using `yarn compile`.

> **Note:** The deployment data shown below is sourced from the [compound-docs-aggregator](https://github.com/woof-software/compound-docs-aggregator) repository. Data collected on: **2026-02-28 12:34:36.611 UTC**.
