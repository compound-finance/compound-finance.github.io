...
risk weights (called [Collateral Factors](/v2/comptroller/index.html.md#collateral-factor)) to make its determinations. Users explicitly list which assets they would like included in their risk scoring, by calling [Enter Markets](/v2/comptroller/index.html.md#enter-markets) and [Exit Market](/v2/comptroller/index.html.md#exit-market).
...
* `RETURN`: For each market, returns an error code indicating whether or not it was entered. Each is 0 on success, otherwise an [Error code](/v2/comptroller/index.html.md#error-codes).
...
* `RETURN`: 0 on success, otherwise an [Error code](/v2/comptroller/index.html.md#error-codes).
...
Get the list of markets an account is currently entered into. In order to supply collateral or borrow in a market, it must be entered first. Entered markets count towards [account liquidity](/v2/comptroller/index.html.md#account-liquidity) calculations.
...
> Note: Collateral factors can be increased (or decreased) through Compound Governance, as market conditions change.
...
For each market the user has [entered](/v2/comptroller/index.html.md#enter-markets) into, their supplied balance is multiplied by the market’s [collateral factor](/v2/comptroller/index.html.md#collateral-factor), and summed; borrow balances are then subtracted, to equal Account Liquidity. Borrowing an asset reduces Account Liquidity for each USD borrowed; withdrawing an asset reduces Account Liquidity by the asset’s collateral factor times each USD withdrawn.
...
* `RETURN`: Tuple of values (error, liquidity, shortfall). The error shall be 0 on success, otherwise an [error code](/v2/comptroller/index.html.md#error-codes). A non-zero liquidity value indicates the account has available [account liquidity](/v2/comptroller/index.html.md#account-liquidity). A non-zero shortfall value indicates the account is currently below his/her collateral requirement and is subject to liquidation. At most one of liquidity or shortfall shall be non-zero.
...
| Event | Description |
|-------|-------------|
| `MarketEntered(CToken cToken, address account)` | Emitted upon a successful [Enter Market](/v2/comptroller/index.html.md#enter-markets). |
| `MarketExited(CToken cToken, address account)` | Emitted upon a successful [Exit Market](/v2/comptroller/index.html.md#exit-market). |
