...
deployments:
  ...
  Ethereum Mainnet - WETH Base:
    ...
    contracts:
      ...
      cWETHv3 Implementation: '0x5cF3bE8F5aFB6e3957A2D56cCE4FaA3135D27846'
...
<br />
> **Note:** The deployment data shown below is sourced from the [compound-docs-aggregator](https://github.com/woof-software/compound-docs-aggregator){:target="_blank"} repository. Data collected on: **2026-04-09 13:14:06.701 UTC**.
