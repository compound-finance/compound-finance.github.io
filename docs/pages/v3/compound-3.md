...
deployments:
  ...
  Ethereum Mainnet - WETH Base:
    ...
    contracts:
      ...
      cWETHv3 Implementation: '0xB75dF0913b27E2E72a78c843FDA2D419aDFd2704'
  ...
  Polygon Mainnet - USDC Base:
    ...
    contracts:
      ...
      cUSDCv3 Implementation: '0x5C5e6E6FbC218dba91E4911C606A8363d26C7AeB'
      ...
      WPOL:
        ...
        Liquidation Penalty Raw: '900000000000000000'
        Supply Cap: '490.73K'
        Supply Cap Raw: '490731000000000000000000'
      ...
      MaticX:
        ...
        Liquidation Penalty Raw: '800000000000000000'
        Supply Cap: '238.54K'
        Supply Cap Raw: '238536000000000000000000'
  ...
  Polygon Mainnet - USDT Base:
    ...
    contracts:
      ...
      cUSDTv3 Implementation: '0x7512Ae36102330bDd30229B15C18f79b91523d42'
      ...
      WPOL:
        ...
        Liquidation Penalty Raw: '850000000000000000'
        Supply Cap: '202.25K'
        Supply Cap Raw: '202246000000000000000000'
        Price Feed: '0xAB594600376Ec9fD91F8e885dADF0CE036862dE0'
      WETH:
        address: '0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619'
        Borrow CF: '80.0%'
      ...
      MaticX:
        ...
        Liquidation Penalty Raw: '800000000000000000'
        Supply Cap: '161.14K'
        Supply Cap Raw: '161140000000000000000000'
        Price Feed: '0x5d37E4b374E6907de8Fc7fb33EE3b0af403C7403'
      stMATIC:
        address: '0x3A58a54C066FdC0f2D55FC9C89F0415C92eBf3C4'
        Borrow CF: '0.0%'
  ...
  Linea - USDC Base:
    ...
    contracts:
      ...
      cUSDCv3 Implementation: '0x235683bAf251b30158dBF66439D98ae737686d73'
  ...
  Linea - WETH Base:
    ...
    contracts:
      ...
      cWETHv3 Implementation: '0xA53E807a433d552a03949cD6B4ee756d1fF2a4d6'
...
<br />
> **Note:** The deployment data shown below is sourced from the [compound-docs-aggregator](https://github.com/woof-software/compound-docs-aggregator){:target="_blank"} repository. Data collected on: **2026-07-20 13:54:17.343 UTC**.
